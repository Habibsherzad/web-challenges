...
const areaPizza = Math.PI * pizzaRadius ** 2;
const circumference = 2 * Math.PI * pizzaRadius;
console.log(
  `Area of a pizza with the radius ${pizzaRadius} cm is: ${areaPizza} cm^2 and the circumference is ${circumference} cm.`
);
